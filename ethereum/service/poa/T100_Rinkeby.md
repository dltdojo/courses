...
--------------------------------------------------------------
poa_base_1    echo base       Exit 0
poa_node0_1   ./startdev.sh   Up       0.0.0.0:8545->8545/tcp
poa_node1_1   ./startdev.sh   Up       0.0.0.0:18545->8545/tcp
poa_node2_1   ./startdev.sh   Up       0.0.0.0:28545->8545/tcp
poa_node3_1   ./startdev.sh   Up       0.0.0.0:38545->8545/tcp
...
coinbase: 0xbfdae52c9309862a3c491ada373afa56cb8b3b34
at block: 1 (Tue, 05 Sep 2017 04:14:54 UTC)
 datadir: /root/.ethereum
 modules: admin:1.0 clique:1.0 debug:1.0 eth:1.0 miner:1.0 net:1.0 personal:1.0 rpc:1.0 txpool:1.0 web3:1.0

> admin.stopRPC()
> admin.startRPC("0.0.0.0", 8545, "*", "miner,admin,db,personal,eth,net,web3")
> personal.unlockAccount(eth.accounts[0], "MDFiYTQ3MTljODBi", 7200)
> exit
bash-4.3# exit
exit
```

### T100_Token.sol deployment on node0

* http://remix.ethereum.org/
* Web Provider http://VMIP:8545
...
### T100_Token.sol on node1

* http://remix.ethereum.org/
* Web Provider http://VMIP:18545
* FooToken - At Address (FooToken-Deployment@node0)
* FooToken - balanceOf()
